...
# 读取数据文件
file1 = "/raid_sdh/home/xyg/flare/attention_scores-qwen2.5.csv"
file2 = "/raid_sdh/home/xyg/flare/attention_scores-allrope.csv"
fill3 = "/raid_sdh/home/xyg/flare/attention_scores-somerope[20-32].csv"
fill4 = "/raid_sdh/home/xyg/flare/attention_scores-somerope[20-33].csv"
df1 = pd.read_csv(file1)
df2 = pd.read_csv(file2)
df3 = pd.read_csv(fill3)
df4 = pd.read_csv(fill4)

df1['Model'] = 'Baseline'
df2['Model'] = 'AllRoPE'
df3['Model'] = 'SomeRoPE[20-32]'
df4['Model'] = 'SomeRoPE[20-33]'
